...
plugin.load = function(arg, next) {
	...
	router.get( '/authenticate', cas.bounce, function ( req, res ) {
		...
		db.getObjectField('schoolnumber:uid', schoolnumber, function(err, ans) {
			console.log(2);
			if (err) {
				console.log('err');
			}else {
		...
		db.getObjectField('uid:34', 'schoolnumber', function(err, ans) {
			console.log(3);
			if (err) {
				console.log('err');
			}else {
		...
		var addCustomData = {
			schoolnumber : '2014302537'
		}

		db.sortedSetScore('ns:custom_fields:uid', addCustomData, function(err, ans) {
			console.log(4);
			if (err) {
				console.log('err');
			}else {
		...
		db.sortedSetScore('username:uid', 'pwl', function(err, ans) {
			console.log(5);
			if (err) {
				console.log('err');
			}else {
		...
		if (username && password && host && port && database) {
			...
			obj.find({'schoolnumber' : '2014302537'}).toArray(function(err, res) {
				if (err) {
					console.log(err);
